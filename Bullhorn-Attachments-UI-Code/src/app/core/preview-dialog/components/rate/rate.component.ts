  ...
  public set reviewData(data: PlacementReviewDataModel) {
    if (data) {
        ...
        if (this.allReviewData.assignment) {
          if (this.allReviewData?.assignment?.perDiemStartDate) this.allReviewData.assignment.perDiemStartDate = this.dateFormatService.convert_mmddyyyy_hypen_to_mmddyyyy_slash(this.allReviewData.assignment.perDiemStartDate);
          if (this.allReviewData?.assignment?.perDiemEndDate) this.allReviewData.assignment.perDiemEndDate = this.dateFormatService.convert_mmddyyyy_hypen_to_mmddyyyy_slash(this.allReviewData.assignment.perDiemEndDate);
      }
    }
  }
