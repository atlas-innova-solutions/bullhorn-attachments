    ...
    public set reviewData(data: PlacementReviewDataModel) {
        if (data) {
            ...
            if (this.allReviewData.assignment) {
                if (this.allReviewData.assignment.poEffective) this.allReviewData.assignment.poEffective = this.dateFormatService.convert_mmddyyyy_hypen_to_mmddyyyy_slash(this.allReviewData.assignment.poEffective);
                if (this.allReviewData.assignment.poEnd) this.allReviewData.assignment.poEnd = this.dateFormatService.convert_mmddyyyy_hypen_to_mmddyyyy_slash(this.allReviewData?.assignment?.poEnd);
            }
        }
    }
