...
@Component({
    selector: 'app-worker-relationship',
    templateUrl: './worker-relationship.component.html',
    styleUrl: './worker-relationship.component.scss'
})
export class WorkerRelationshipComponent {
